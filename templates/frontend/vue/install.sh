#!/bin/sh
#
# Vue テンプレートの全ファイルをインストールするスクリプト
#
# 使い方:
...
BASE_URL="https://raw.githubusercontent.com/Takuya0202/my-project-setting/main/templates/frontend/vue"
...
install_file ".claude/skills/vue/SKILL.md" ".claude/skills/vue/SKILL.md"
install_file ".cursor/skills/vue/SKILL.md" ".cursor/skills/vue/SKILL.md"
